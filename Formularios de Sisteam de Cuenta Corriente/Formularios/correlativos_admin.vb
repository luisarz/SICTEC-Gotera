...
Public Class correlativos_admin
    ...
    Private Sub correlativos_admin_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If lectorcmd.Read Then
            txtNumero.Text = lectorcmd("ultimo_recibo").ToString
            txtSerie.Text = lectorcmd("serie").ToString
        End If
        lectorcmd.Close()
    End Sub
    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        Try
            Dim cmd As New SqlClient.SqlCommand("UPDATE correlativo SET ultimo_recibo='" & txtNumero.Text & "', serie='" & txtSerie.Text & "'", cnxConectionsServer)
